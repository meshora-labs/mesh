			...
			<div className="workspace-frame">
				<main
					className={
						isContextPanelOpen
							? "main-surface"
							: "main-surface main-surface--context-closed"
					}
				>
						...
						{activeRoute === "projects" ? (
							<ProjectsPage
								...
								onAddLocalProject={async (nameInput, localPathInput) => {
									const project = await data.addLocalProject(
										nameInput,
										localPathInput,
									);
								...
								onCloneGitProject={async (
									nameInput,
									urlInput,
									destinationInput,
								) => {
									const project = await data.cloneGitProject(
										nameInput,
										urlInput,
										destinationInput,
									);
